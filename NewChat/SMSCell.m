...
@synthesize headImg,bubbleImg,numLabel,nameLabel,styleImg,dateLabel,fromLabel;
...
-(void)layoutSubviews
{
    ...
    [numLabel setFrame:CGRectMake(3, 3, 12,11)];
    [nameLabel setFrame:CGRectMake(6.75f*2+55, 21.75f, 100, 25)];
